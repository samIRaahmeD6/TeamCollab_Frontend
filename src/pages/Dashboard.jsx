...
export const Dashboard = () => {
  ...
  useEffect(() => {
    if (!loggedInUser?.id) return;
     ...
     const newSocket = io("https://hasibul-rupok.com", {
    path: "/teamCollab/socket.io/",
    auth: { userId: loggedInUser.id },
    transports: ["websocket", "polling"],   // both needed!
  ...
  // Fetch messages
  useEffect(() => {
    fetch("https://hasibul-rupok.com/teamCollab/api/messages")
      .then((res) => res.json())
  ...
  // Fetch users
  useEffect(() => {
    fetch("https://hasibul-rupok.com/teamCollab/api/users", {
...
useEffect(() => {
  ...
  fetch(`https://hasibul-rupok.com/teamCollab/api/tasks/${userId}`) // <-- pass userId
    .then((res) => res.json())
    .then((data) => {
  ...
  const handleSend = async () => {
    ...
    try {
      await fetch("https://hasibul-rupok.com/teamCollab/api/messages", {
        method: "POST",
  ...
  const handleAssignTask = async () => {
    ...
    try {
      const res = await fetch("https://hasibul-rupok.com/teamCollab/api/assign-task", {
        method: "POST",
  ...
  const handleDragEnd = async (result) => {
    ...
    try {
      ...
      const res = await fetch(`https://hasibul-rupok.com/teamCollab/api/tasks/${movedTask.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
